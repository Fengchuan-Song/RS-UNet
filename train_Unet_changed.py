...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    model_path = "logs/loss_2022_08_10_16_31_47/ep119-loss0.010-val_loss0.009.pth"
    # model_path = ""
    # ------------------------------#
    #   输入图片的大小
    # ------------------------------#
    ...
    model = Net(num_classes=num_classes, r=[8, 16, 32, 64, 128], pretrained=pretrained).train()
    if not pretrained:
        weights_init(model)
    if model_path != '':
        # ------------------------------------------------------#
