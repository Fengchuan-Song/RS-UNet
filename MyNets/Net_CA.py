...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, reduction):
        ...
        self.attention = CoordAttention(inp=out_channels, oup=out_channels, reduction=reduction)
...
class Encoder(nn.Module):
    ...
    def __init__(self, in_channels, num_channels, r):
        ...
        self.encoder_1 = BasicBlock(in_channels=in_channels, out_channels=num_channels[0], reduction=r[0])
        self.encoder_2 = BasicBlock(in_channels=num_channels[0], out_channels=num_channels[1], reduction=r[1])
        self.encoder_3 = BasicBlock(in_channels=num_channels[1], out_channels=num_channels[2], reduction=r[2])
        self.encoder_4 = BasicBlock(in_channels=num_channels[2], out_channels=num_channels[3], reduction=r[3])
        self.encoder_5 = BasicBlock(in_channels=num_channels[3], out_channels=num_channels[4], reduction=r[4])
