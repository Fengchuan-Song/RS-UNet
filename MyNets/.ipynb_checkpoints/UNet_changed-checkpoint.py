...
from MyNets.Net_1 import Encoder
...
class Net(nn.Module):
    ...
    def __init__(self, num_classes, r, pretrained=False):
        ...
        self.encoder = Encoder(in_channels=3, num_channels=[32, 64, 128, 256, 512], r=r)
...
#                                stride=(1, 1), padding=0)
        ...
        self.up_block1 = UpBlock_1(in_channels=[32, 256])

        self.final = nn.Conv2d(in_channels=256, out_channels=num_classes, kernel_size=(1, 1),
                               stride=(1, 1), padding=0)
